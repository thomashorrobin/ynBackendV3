...
class AnnouncementsControllerTest < ActionController::TestCase
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post :create, announcement: { Exec_id: @announcement.Exec_id, announced_at: @announcement.announced_at, message: @announcement.message }
    end
  ...
  test "should update announcement" do
    patch :update, id: @announcement, announcement: { Exec_id: @announcement.Exec_id, announced_at: @announcement.announced_at, message: @announcement.message }
    assert_redirected_to announcement_path(assigns(:announcement))
  end
